...
<html>
    ...
    <body>
        ...
        <div class="container box">
            <div class="row">
                <div class="ongoing col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <h4 class="theader">Ongoing</h4>
                    <div class="searchbar">
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM questionanswer WHERE teacherId = '$id' AND status= 'Ongoing'";
                        $result = $conn->query($sql);
                    ?>
                ...
                <div class="closed col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <h4 class="theader">Closed</h4>
                    <div class="searchbar">
                        <input type="text" id="search" placeholder="Type to search....." class="search">
                    </div>
                    <?php
                        ...
                        $sql = "SELECT * FROM questionanswer WHERE teacherId = '$id' AND status= 'Closed'";
                        $result = $conn->query($sql);
                    ?>
                    <table id="detailTable1">
                            <thead>
