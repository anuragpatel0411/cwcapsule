<?php
    ...
    if(isset($_POST['submitStudent'])){
        ...
        if($password != $repass){
            ...
            $stmt = $conn->prepare("INSERT INTO students(studentName, email, mobile, birthDate, course, majorSubject, pass, verified) VALUES (?, ?, ?, ?, ?, ?, ?, FALSE)");
            $stmt->bind_param("sssssss", $name, $email, $mobile, $dob, $course, $subject, $password);
            $stmt->execute();  
            ...
            $to = $email;
            $subject = "Email Verification for CW Capsule";
    
            $from_email	= "cwcapsule.gmail.com";
            ...
            $message .= $url."verifymail.php?email=". $email . "&name=" . $name . "&r=s";
    
            $headers = "From: $from_email\r\nReply-To: $from_email";
    
            $headers .= 'Cc: [email]patelanurag.0411@gmail.com[/email]' . "\\r\ "; 
    ...
    if(isset($_POST['submitTeacher'])){
        ...
        if($password != $repass){
            ...
            $stmt = $conn->prepare("INSERT INTO teachers(teacherName, email, mobile, birthDate, qualification, subject, pass, mailVerified, testPass, documentVerified ) VALUES (?, ?, ?, ?, ?, ?, ?, FALSE, FALSE, FALSE)");
            $stmt->bind_param("sssssss", $name, $email, $mobile, $dob, $qualification, $subject, $password);
            $stmt->execute();  
            ...
            We require you to verify your email to keep your account secure and to recover your account.
            Click pn the link to verify your email.<br>";
            $message .= $url . "verifymail.php?email=". $email . "&name=" . $name . "&r=t";
...
<html>
	...
	<body class="regdbox">
        ...
        <div class="row">
                ...
                <div id="student" style="display:block;" class="tabcontent">            
                    <form method="post" class="row">
                        <span class="col-12 col-md-6">
                            <input type="text" class="formInput" placeholder="First Name" name="fname">
                        </span>
                        <span class="col-12 col-md-6">
                            <input type="text" class="formInput" placeholder="Last Name" name="lname">
                        </span>
                        <span class="col-12 col-md-6">
                            <input type="email" class="formInput" placeholder="Email" name="email">
                        </span>
                        <span class="col-12 col-md-6">
                            <input type="text" name="dob" class="formInput" data-date-inline-picker="true" onfocus="(this.type='date')" placeholder="Date of Birth">                   
                        </span>
                        <span class="col-12 col-md-6">
                        ...
                        <span class="col-12 col-md-6">
                            <input type="password" class="formInput" placeholder="Retype Password" name="repass">
                        </span>
            ...
            <div class="col-12 col-sm-12 col-md-8 col-lg-6 col-xl-6 box" style="display:<?php echo $classmail; ?>;">
                <h3>Verify Your Email Address</h3>
                <p>We now need to verify your email address.We've sent an email to <?php echo $email;?> to verify your addressPlease click the link in that email to continue.<p>
